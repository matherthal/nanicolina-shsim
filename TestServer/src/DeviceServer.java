...
public class DeviceServer {
	...
	public DeviceServer(String serverIP, int serverPort)
	{
	    try {
	        ...
	        try {
	            ...
	            Logger.getLogger(DeviceServer.class.getName()).log(Level.SEVERE, null, ex);
	        }
	...
	public DeviceServer(int serverPort)
	{
	    try {
			serv = new ServerSocket(serverPort);
		} catch (IOException e) {
