...
public class ResourceServer {
	...
	public ResourceServer(String serverIP, int serverPort)
	{
	    try {
	        ...
	        try {
	            ...
	            Logger.getLogger(ResourceServer.class.getName()).log(Level.SEVERE, null, ex);
	        }
	...
	public ResourceServer(int serverPort)
	{
	    try {
			serv = new ServerSocket(serverPort);
		} catch (IOException e) {
